                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                    ...
                    <li className="group relative">
                      <a href="#homeRef" className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 text-primary dark:text-white`}>
                          Home
                      </a>
                    </li>
                    <li className="group relative">
                      <a href="#servicesRef" className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6  text-primary dark:text-white`}>
                          Service
                      </a>
                    </li>
                    <li className="group relative">
                      <a href="#whyMsquareRef" className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6  text-primary dark:text-white`}>
                          Why Msquare ?
                      </a>
                    </li>
